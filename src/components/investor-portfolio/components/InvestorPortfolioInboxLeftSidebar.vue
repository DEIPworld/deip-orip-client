  ...
  export default {
    ...
    methods: {
      ...
      addNewList() {
        ...
        this.$store.dispatch('investorPortfolio/addNewInvestmentList', { listId, listName, color })
          .finally(() => {
      ...
      editCustomList() {
        ...
        this.$store.dispatch('investorPortfolio/editInvestmentList', { listId, listName, color })
          .finally(() => {
