    ...
    <div class="page-container">
      ...
      <v-form v-model="isFormValid" ref="form" class="c-mt-10">
        <div class="c-pb-6">
          ...
          <br>
          To finish the registration and getting limit-less access to the newest research please type your name and save
          the private key
        </div>
        ...
        >{{ !formData.privKey ? 'Generate' : 'Re-generate' }} private key
        </v-btn>
