...
<script>
  import AttributesTextRead from '@/components/Attributes/AttributesText/AttributesTextRead';
  ...
  import AttributesMultiSelectRead from '@/components/Attributes/AttributesMultiSelect/AttributesMultiSelectRead';
