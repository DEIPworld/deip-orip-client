...
<script>
  ...
  import { attributeEdit } from '@/components/Attributes/mixins/edit/attributeEdit';

  import AttributeEditProps from '@/components/Attributes/mixins/edit/_partials/AttributeEditProps';
  import AttributeEditMeta from '@/components/Attributes/mixins/edit/_partials/AttributeEditMeta';
  import AttributeEditOptions from '@/components/Attributes/mixins/edit/_partials/AttributeEditOptions';
