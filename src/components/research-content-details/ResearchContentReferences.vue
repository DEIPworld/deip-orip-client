            ...
            <v-flex xs12 sm12 md8 lg8 xl8>
              <v-layout class="full-width" column>
                ...
                <div ref="graphContainer" style="height: 400px">
                  <references-dependency-graph v-if="isMounted" :data="researchContentReferencesGraph"
                                               :width="graphWidth" :height="graphHeight"></references-dependency-graph>
                </div>
              </v-layout>
            </v-flex>
                    ...
                    <v-tab-item value="tab-file">
                      <v-layout column class="pt-3">
                        ...
                        <v-layout class="py-3" row justify-space-between align-baseline>
                          ...
                          <v-flex xs8>
                            <v-layout align-baseline>
                              <img width="20px" height="20px" class="align-self-center"
                        ...
                        <v-layout v-if="contentReviewsList.length" class="py-3" row justify-space-between
                                  align-baseline>
                          <v-flex xs4>
                            <span class="body-2">Verified by:</span>
                          </v-flex>
                          <v-flex xs8>
                            <v-layout align-baseline row justify-space-between v-for="(review, i) in contentReviewsList"
                                      :key="`file-verifier-${i}`" :class="{'py-2': i != 0}">
                              <platform-avatar
                                :user="review.author"
                                :size="20"
                                link-to-profile
