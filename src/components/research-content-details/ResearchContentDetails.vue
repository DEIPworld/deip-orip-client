      ...
      <div class="full-height">
        <v-row>
          ...
          <v-col>
            ...
            <div v-if="isPublished && contentReviewsList.length" class="px-12 py-6">
              <div id="reviews">
            ...
            <div v-if="isPublished && !isResearchGroupMember" class="px-12 pt-2 pb-12">
              <v-card class="py-6 px-12">
                <v-row id="reviews" class="py-2">
                  ...
                  <v-col class="grow pl-12" align-self="center">
                    <div class="pb-4">
                      <div v-if="!contentReviewsList.length" class="pb-1 subtitle-1 half-bold">
                        There are no reviews for
                        this material yet
                      </div>
                      <div v-if="userHasResearchExpertise && !userHasReview">
                        You will get <span class="body-2">approximately 3000 ECI reward in {{ userRelatedExpertise.map(exp => exp.discipline_name).join(', ') }}</span>
