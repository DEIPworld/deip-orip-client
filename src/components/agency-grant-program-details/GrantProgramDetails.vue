          ...
          <v-layout row wrap>
            <v-flex xs9>
              ...
              <v-card class="pa-4 elevation-0">
                <v-layout row wrap>
                  <v-flex xs12>
                    <div class="display-1 py-4">{{program.additional_info.funding_opportunity_title}}</div>
                  </v-flex>
                  <v-flex xs12>
                    <v-divider></v-divider>
                    <v-layout py-3>
                    ...
                    <v-layout pt-3>
                      ...
                      <v-flex flex-1 body-1>Current funding:</v-flex>
                      <v-flex flex-1 body-2>$ {{fromAssetsToFloat(program.current_supply)}}</v-flex>
                    </v-layout>
                    <v-layout pt-3>
