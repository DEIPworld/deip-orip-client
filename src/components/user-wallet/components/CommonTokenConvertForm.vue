  ...
  <v-card>
    ...
    <div class="c-p-4">
      <v-form ref="form" @submit.prevent>
        <div class="c-pb-4">
          <div v-if="isDeipToCommonMode">
            1 DEIP Token = 1 DEIP Commons
          </div>
          <div v-else>
            1 DEIP Common = 1 DEIP Tokens
          </div>
        </div>
        ...
        <div
          class="align-center justify-space-around c-pv-6"
        ...
        >
          <div class="legacy-column width-5">
            ...
            <div class="c-m-auto caption grey--text">
              DEIP Token
            </div>
          </div>
      ...
      return {
        ...
        rules: {
          ...
          deipCommonAmount: (value) => {
            ...
            } if (number > this.commonTokensBalance) {
      ...
      convert() {
        if (this.$refs.form.validate()) {
          ...
          promise.then((data) => {
            ...
            this.$notifier.show('Converting transaction was applied', 'success')
